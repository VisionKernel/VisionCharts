...
export default class SvgRenderer {
    ...
    /**
     * Generate a candlestick path definition
     * @param {number} x - X coordinate
     * @param {number} open - Open price
     * @param {number} high - High price
     * @param {number} low - Low price
     * @param {number} close - Close price
     * @param {number} width - Candlestick width
     * @returns {string} Path definition string
     */
    static candlestickPathDefinition(x, open, high, low, close, width) {
      ...
      const pathParts = [
        ...
        `L ${x},${low}`,
        // Body
        `M ${x - halfWidth},${bodyTop}`,
        `L ${x + halfWidth},${bodyTop}`,
        `L ${x + halfWidth},${bodyBottom}`,
        `L ${x - halfWidth},${bodyBottom}`,
        `Z`
      ];
