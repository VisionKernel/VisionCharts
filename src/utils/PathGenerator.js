export class PathGenerator {
  ...
  async generatePath(dataset, options = {}) {
    ...
    return {
      ...
      fillOpacity: dataset.fillOpacity !== undefined ? dataset.fillOpacity : (pathOptions.fillOpacity || 0.3),
      vertices: vertices,
      colors: colors,
  ...
  _createEmptyPath(dataset) {
    return {
      ...
      color: dataset.color,
      fill: dataset.fill || false,
      fillOpacity: dataset.fillOpacity !== undefined ? dataset.fillOpacity : 0.3,
      vertices: [],
      colors: [],
